...
Role   : Time-Series Construction (Areesha)
Input  : Yahoo Finance prices + Sentiment CSVs (labeled by Mobeen)
Output : dataset/processed/timeseries_dataset.csv
         dataset/processed/feature_columns.json

Run:
    python timeseries_construction.py
"""
...
# ─────────────────────────────────────────────────────────────────────────────
#  ALL CONFIGURABLE SETTINGS LIVE HERE — same paths as your working original
#  Uses os.path (identical to your original BASE_DIR approach)
# ─────────────────────────────────────────────────────────────────────────────

# Project root — go up 3 levels from this file:
#   src/timeseries/timeseries_construction.py
#     → src/timeseries/   (dirname once)
#     → src/              (dirname twice)
#     → project root      (dirname thrice)
BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Input file paths — identical to your original
...
# Output paths — identical to your original
...
# ════════════════════════════════════════════════════════════
# SECTION 16 — FASTAPI-READY REAL-TIME FUNCTION (module-level)
# Importable by FastAPI without running the full pipeline
# ════════════════════════════════════════════════════════════
...
if __name__ == '__main__':
    ...
    print('\n✅ timeseries_construction.py pipeline complete.')